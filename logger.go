...
//
// The variadic args should be entered as pairs, with the odd numbered acting as keys for the next
// value. Adding an odd number of arguments here will result in unpredictable behaviour.
//
